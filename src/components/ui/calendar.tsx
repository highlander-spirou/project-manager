...
function Calendar({
  ...
  const variants = {
    compact: {
      ...
      // display the div contains caption, nav and nav button
      month: "space-y-2",
      ...
      head_row: "flex",
      head_cell:
        "text-gray-500 rounded-md w-full font-normal text-[0.8rem] dark:text-gray-400",
      row: "flex w-full mt-1",
      cell: "h-6 w-6 text-center p-0 relative [&:has([aria-selected])]:bg-gray-100 first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md focus-within:relative focus-within:z-20 dark:[&:has([aria-selected])]:bg-gray-800",
      day: cn(
